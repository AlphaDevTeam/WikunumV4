...
export class ItemAddOnsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.itemAddOnsService
      ...
      .subscribe(
        (res: HttpResponse<IItemAddOns[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInItemAddOns(): void {
    this.eventSubscriber = this.eventManager.subscribe('itemAddOnsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IItemAddOns[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/item-add-ons'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
