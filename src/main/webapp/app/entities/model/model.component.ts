...
export class ModelComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.modelService
      ...
      .subscribe(
        (res: HttpResponse<IModel[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInModels(): void {
    this.eventSubscriber = this.eventManager.subscribe('modelListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IModel[] | null, headers: HttpHeaders, page: number): void {
