...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'quotation',
        loadChildren: () => import('./quotation/quotation.module').then(m => m.WikunumQuotationModule)
      },
      {
        path: 'quotation-details',
        loadChildren: () => import('./quotation-details/quotation-details.module').then(m => m.WikunumQuotationDetailsModule)
      },
      {
        path: 'purchase-order',
      ...
      {
        path: 'cost-of-sales-account',
        loadChildren: () => import('./cost-of-sales-account/cost-of-sales-account.module').then(m => m.WikunumCostOfSalesAccountModule)
      },
      {
        path: 'cost-of-sales-account-balance',
        loadChildren: () =>
          import('./cost-of-sales-account-balance/cost-of-sales-account-balance.module').then(m => m.WikunumCostOfSalesAccountBalanceModule)
      },
      {
        path: 'employee-account',
        loadChildren: () => import('./employee-account/employee-account.module').then(m => m.WikunumEmployeeAccountModule)
      },
      {
        path: 'employee-account-balance',
        loadChildren: () =>
          import('./employee-account-balance/employee-account-balance.module').then(m => m.WikunumEmployeeAccountBalanceModule)
      },
      {
        path: 'document-type',
      ...
      {
        path: 'employee-type',
        loadChildren: () => import('./employee-type/employee-type.module').then(m => m.WikunumEmployeeTypeModule)
      },
      {
        path: 'employee',
        loadChildren: () => import('./employee/employee.module').then(m => m.WikunumEmployeeModule)
      },
      {
        path: 'ex-user',
      ...
      {
        path: 'stock-transfer',
        loadChildren: () => import('./stock-transfer/stock-transfer.module').then(m => m.WikunumStockTransferModule)
      },
      {
        path: 'license-type',
        loadChildren: () => import('./license-type/license-type.module').then(m => m.WikunumLicenseTypeModule)
      },
      {
        path: 'company',
