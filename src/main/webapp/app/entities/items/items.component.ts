...
export class ItemsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.itemsService
      ...
      .subscribe(
        (res: HttpResponse<IItems[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInItems(): void {
    this.eventSubscriber = this.eventManager.subscribe('itemsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IItems[] | null, headers: HttpHeaders, page: number): void {
