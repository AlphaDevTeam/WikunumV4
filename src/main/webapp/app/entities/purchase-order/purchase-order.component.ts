...
export class PurchaseOrderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.purchaseOrderService
      ...
      .subscribe(
        (res: HttpResponse<IPurchaseOrder[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IPurchaseOrder[] | null, headers: HttpHeaders, page: number): void {
