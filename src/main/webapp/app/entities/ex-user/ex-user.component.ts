...
export class ExUserComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.exUserService
      ...
      .subscribe(
        (res: HttpResponse<IExUser[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInExUsers(): void {
    this.eventSubscriber = this.eventManager.subscribe('exUserListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExUser[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/ex-user'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
