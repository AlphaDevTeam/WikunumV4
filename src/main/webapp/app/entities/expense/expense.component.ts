...
export class ExpenseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.expenseService
      ...
      .subscribe(
        (res: HttpResponse<IExpense[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInExpenses(): void {
    this.eventSubscriber = this.eventManager.subscribe('expenseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExpense[] | null, headers: HttpHeaders, page: number): void {
