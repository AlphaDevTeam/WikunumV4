...
/**
 * Criteria class for the {@link com.alphadevs.sales.domain.CashPaymentVoucherCustomer} entity. This class is used
 * in {@link com.alphadevs.sales.web.rest.CashPaymentVoucherCustomerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cash-payment-voucher-customers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CashPaymentVoucherCustomerCriteria implements Serializable, Criteria {
    ...
    public CashPaymentVoucherCustomerCriteria(){
    }

    public CashPaymentVoucherCustomerCriteria(CashPaymentVoucherCustomerCriteria other){
    ...
    @Override
    public CashPaymentVoucherCustomerCriteria copy() {
        return new CashPaymentVoucherCustomerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CashPaymentVoucherCustomerCriteria that = (CashPaymentVoucherCustomerCriteria) o;
        return
    ...
    public String toString() {
        return "CashPaymentVoucherCustomerCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
