...
/**
 * Criteria class for the {@link com.alphadevs.sales.domain.CostOfSalesAccount} entity. This class is used
 * in {@link com.alphadevs.sales.web.rest.CostOfSalesAccountResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cost-of-sales-accounts?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CostOfSalesAccountCriteria implements Serializable, Criteria {
    ...
    public CostOfSalesAccountCriteria(){
    }

    public CostOfSalesAccountCriteria(CostOfSalesAccountCriteria other){
    ...
    @Override
    public CostOfSalesAccountCriteria copy() {
        return new CostOfSalesAccountCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CostOfSalesAccountCriteria that = (CostOfSalesAccountCriteria) o;
        return
    ...
    public String toString() {
        return "CostOfSalesAccountCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
