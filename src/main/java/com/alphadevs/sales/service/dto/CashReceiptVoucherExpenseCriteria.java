...
/**
 * Criteria class for the {@link com.alphadevs.sales.domain.CashReceiptVoucherExpense} entity. This class is used
 * in {@link com.alphadevs.sales.web.rest.CashReceiptVoucherExpenseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cash-receipt-voucher-expenses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CashReceiptVoucherExpenseCriteria implements Serializable, Criteria {
    ...
    public CashReceiptVoucherExpenseCriteria(){
    }

    public CashReceiptVoucherExpenseCriteria(CashReceiptVoucherExpenseCriteria other){
    ...
    @Override
    public CashReceiptVoucherExpenseCriteria copy() {
        return new CashReceiptVoucherExpenseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CashReceiptVoucherExpenseCriteria that = (CashReceiptVoucherExpenseCriteria) o;
        return
    ...
    public String toString() {
        return "CashReceiptVoucherExpenseCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
