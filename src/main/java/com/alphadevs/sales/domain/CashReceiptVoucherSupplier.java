...
public class CashReceiptVoucherSupplier implements Serializable {
    ...
    public CashReceiptVoucherSupplier transactionNumber(String transactionNumber) {
    ...
    public CashReceiptVoucherSupplier transactionAmount(BigDecimal transactionAmount) {
