...
public class Items implements Serializable {
    ...
    @Column(name = "item_promotional_percentage")
    private Double itemPromotionalPercentage;
    ...
    public Double getItemPromotionalPercentage() {
        return itemPromotionalPercentage;
    }

    public Items itemPromotionalPercentage(Double itemPromotionalPercentage) {
        this.itemPromotionalPercentage = itemPromotionalPercentage;
        return this;
    }

    public void setItemPromotionalPercentage(Double itemPromotionalPercentage) {
        this.itemPromotionalPercentage = itemPromotionalPercentage;
    }
    ...
    public String toString() {
        return "Items{" +
            ...
            ", itemPromotionalPercentage=" + getItemPromotionalPercentage() +
