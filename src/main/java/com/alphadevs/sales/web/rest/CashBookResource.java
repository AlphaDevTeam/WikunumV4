...
/**
 * REST controller for managing {@link com.alphadevs.sales.domain.CashBook}.
 */
@RestController
@RequestMapping("/api")
public class CashBookResource {
    ...
    public ResponseEntity<List<CashBook>> getAllCashBooks(CashBookCriteria criteria, Pageable pageable) {
