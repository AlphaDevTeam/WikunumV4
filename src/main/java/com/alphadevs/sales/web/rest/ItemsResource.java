...
/**
 * REST controller for managing {@link com.alphadevs.sales.domain.Items}.
 */
@RestController
@RequestMapping("/api")
public class ItemsResource {
     ...
     */
    @GetMapping("/items")
    public ResponseEntity<List<Items>> getAllItems(ItemsCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Items by criteria: {}", criteria);
        Page<Items> page = itemsQueryService.findByCriteria(criteria, pageable);
