...
/**
 * REST controller for managing {@link com.alphadevs.sales.domain.CashBookBalance}.
 */
@RestController
@RequestMapping("/api")
public class CashBookBalanceResource {
    ...
    public ResponseEntity<List<CashBookBalance>> getAllCashBookBalances(CashBookBalanceCriteria criteria, Pageable pageable) {
