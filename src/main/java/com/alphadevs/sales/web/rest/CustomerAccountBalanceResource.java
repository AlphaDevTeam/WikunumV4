...
/**
 * REST controller for managing {@link com.alphadevs.sales.domain.CustomerAccountBalance}.
 */
@RestController
@RequestMapping("/api")
public class CustomerAccountBalanceResource {
    ...
    public ResponseEntity<List<CustomerAccountBalance>> getAllCustomerAccountBalances(CustomerAccountBalanceCriteria criteria, Pageable pageable) {
