...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.alphadevs.sales.domain.Quotation.class.getName());
            createCache(cm, com.alphadevs.sales.domain.Quotation.class.getName() + ".details");
            createCache(cm, com.alphadevs.sales.domain.QuotationDetails.class.getName());
            ...
            createCache(cm, com.alphadevs.sales.domain.CostOfSalesAccount.class.getName());
            createCache(cm, com.alphadevs.sales.domain.CostOfSalesAccountBalance.class.getName());
            createCache(cm, com.alphadevs.sales.domain.EmployeeAccount.class.getName());
            createCache(cm, com.alphadevs.sales.domain.EmployeeAccountBalance.class.getName());
            ...
            createCache(cm, com.alphadevs.sales.domain.EmployeeType.class.getName());
            createCache(cm, com.alphadevs.sales.domain.Employee.class.getName());
            ...
            createCache(cm, com.alphadevs.sales.domain.StockTransfer.class.getName());
            createCache(cm, com.alphadevs.sales.domain.LicenseType.class.getName());
