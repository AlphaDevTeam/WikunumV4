...
describe('Service Tests', () => {
  describe('SupplierAccount Service', () => {
    ...
    let expectedResult: ISupplierAccount | ISupplierAccount[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a SupplierAccount', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            transactionDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a SupplierAccount', () => {
        const returnedFromService = Object.assign(
          {
            transactionDate: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of SupplierAccount', () => {
        const returnedFromService = Object.assign(
          {
            transactionDate: currentDate.format(DATE_FORMAT),
            transactionDescription: 'BBBBBB',
      ...
      it('should delete a SupplierAccount', () => {
