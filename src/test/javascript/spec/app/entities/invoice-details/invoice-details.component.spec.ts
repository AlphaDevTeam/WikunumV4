...
import { InvoiceDetailsComponent } from 'app/entities/invoice-details/invoice-details.component';
...
describe('Component Tests', () => {
  describe('InvoiceDetails Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.invoiceDetails && comp.invoiceDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
