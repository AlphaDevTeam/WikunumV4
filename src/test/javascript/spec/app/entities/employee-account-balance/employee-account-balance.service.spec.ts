...
describe('Service Tests', () => {
  describe('EmployeeAccountBalance Service', () => {
    ...
    let elemDefault: IEmployeeAccountBalance;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(EmployeeAccountBalanceService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new EmployeeAccountBalance(0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a EmployeeAccountBalance', () => {
        ...
        service
          .create(new EmployeeAccountBalance())
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp.body));
