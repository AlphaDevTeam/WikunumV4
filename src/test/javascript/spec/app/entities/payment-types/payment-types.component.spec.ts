...
import { PaymentTypesComponent } from 'app/entities/payment-types/payment-types.component';
...
describe('Component Tests', () => {
  describe('PaymentTypes Management Component', () => {
    let comp: PaymentTypesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentTypesComponent, '')
        .compileComponents();
