...
describe('Service Tests', () => {
  describe('QuotationDetails Service', () => {
    ...
    let expectedResult: IQuotationDetails | IQuotationDetails[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new QuotationDetails(0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a QuotationDetails', () => {
      ...
      it('should update a QuotationDetails', () => {
        const returnedFromService = Object.assign(
          {
            rate: 1,
            description: 'BBBBBB'
      ...
      it('should return a list of QuotationDetails', () => {
        const returnedFromService = Object.assign(
          {
            rate: 1,
            description: 'BBBBBB'
      ...
      it('should delete a QuotationDetails', () => {
