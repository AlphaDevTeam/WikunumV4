...
import { QuotationDetailsComponent } from 'app/entities/quotation-details/quotation-details.component';
...
describe('Component Tests', () => {
  describe('QuotationDetails Management Component', () => {
    let comp: QuotationDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuotationDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.quotationDetails && comp.quotationDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
