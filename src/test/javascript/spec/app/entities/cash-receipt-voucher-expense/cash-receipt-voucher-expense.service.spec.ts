...
describe('Service Tests', () => {
  describe('CashReceiptVoucherExpense Service', () => {
    ...
    let expectedResult: ICashReceiptVoucherExpense | ICashReceiptVoucherExpense[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new CashReceiptVoucherExpense(0, 'AAAAAAA', currentDate, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a CashReceiptVoucherExpense', () => {
        ...
        service
          .create(new CashReceiptVoucherExpense())
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp.body));
