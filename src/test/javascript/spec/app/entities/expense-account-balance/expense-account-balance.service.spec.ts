...
describe('Service Tests', () => {
  describe('ExpenseAccountBalance Service', () => {
    ...
    let elemDefault: IExpenseAccountBalance;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ExpenseAccountBalanceService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new ExpenseAccountBalance(0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ExpenseAccountBalance', () => {
        ...
        service
          .create(new ExpenseAccountBalance())
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp.body));
