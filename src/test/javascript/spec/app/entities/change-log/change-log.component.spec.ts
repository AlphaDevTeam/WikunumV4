...
import { ChangeLogComponent } from 'app/entities/change-log/change-log.component';
...
describe('Component Tests', () => {
  describe('ChangeLog Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.changeLogs && comp.changeLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
