...
public class WorkerResourceIT {
    ...
    @Test
    @Transactional
    public void getAllWorkersByHistoryIsEqualToSomething() throws Exception {
        // Initialize the database
        workerRepository.saveAndFlush(worker);
        ...
        // Get all the workerList where history equals to historyId
        defaultWorkerShouldBeFound("historyId.equals=" + historyId);

        // Get all the workerList where history equals to historyId + 1
        defaultWorkerShouldNotBeFound("historyId.equals=" + (historyId + 1));
    }
