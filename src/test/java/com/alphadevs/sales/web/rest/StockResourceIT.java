...
public class StockResourceIT {
    ...
    @Test
    @Transactional
    public void getAllStocksByHistoryIsEqualToSomething() throws Exception {
        // Initialize the database
        stockRepository.saveAndFlush(stock);
        ...
        // Get all the stockList where history equals to historyId
        defaultStockShouldBeFound("historyId.equals=" + historyId);

        // Get all the stockList where history equals to historyId + 1
        defaultStockShouldNotBeFound("historyId.equals=" + (historyId + 1));
    }
